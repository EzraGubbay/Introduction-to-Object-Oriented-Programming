...
public class GeometryTester {
    ...
    public boolean testLine() {
        ...
        // My Test
        Line l4 = new Line(294, 267, 356, 18);
        Line l5 = new Line(371, 183, 204, 259);
        ...
        // My Test Evaluation
        double n = 4.9999999, m = 5;
        System.out.println(Math.abs(n - m));
        if(!Point.threshold(n, m)){
            System.out.println("Threshold comparison failed.");
        }
